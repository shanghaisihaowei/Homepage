...
export default defineComponent({
  ...
  methods: {
    ...
    getdetailedinfo() {
      var _this = this
      get('article/api/v1/Browse/' +_this.$q.cookies.get('articleId') + '/' + '?community_type=1').then(res => {
        ...
        _this.meta = {
          description: {name: 'description', content: 'DVAdmin - Open Source Warehouse Management System'},
  ...
  created() {
    ...
    if (_this.$q.cookies.get('lang') === 'zh-hans') {
      ...
      _this.meta = {
        ...
        keywords: {
          name: 'keywords',
          content: 'DVAdmin - Open Source Warehouse Management System, GreaterWMS, greaterwms, wms'
        },
        equiv: {'http-equiv': 'Content-Type', content: 'text/html; charset=UTF-8'},
        ogTitle: {
          property: 'og:title',
